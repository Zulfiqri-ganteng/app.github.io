<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800"><i class="fas fa-user-shield me-2"></i><?= $judul; ?></h1>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-id-card me-2"></i>Informasi Akun</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-key me-2"></i>Ganti Password</h6>
                </div>
                <div class="card-body">
