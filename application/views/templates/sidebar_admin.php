<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseKonten" class="collapse" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <!-- <a href="admin/pengumuman" title="Manajemen Pengumuman"><i class="fas fa-bullhorn"></i> Pengumuman</a> -->
                <a class="collapse-item" href="<?= base_url('admin/pengumuman'); ?>"><i class="fas fa-bullhorn"></i> Pengumuman</a>
                ...
                <a class="collapse-item" href="<?= base_url('admin/gallery'); ?>"><i class="fas fa-book fa-fw me-2"></i> gallery</a>
