<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseKonten" class="collapse" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?= base_url('admin/pengumuman'); ?><i class=" fa fa-info-circle"></i> Pengumuman</a>
                <a class="collapse-item" href="<?= base_url('admin/gallery'); ?><i class=" fa fa-file-image-o"></i> Gallery</a>
